        ...
        <div className="FormCenter">
          <form onSubmit={this.handleSubmit} className="FormFields">
           ...
           {/* Write code here to create description field,submit and cancel buttons */}
              ...
              <input id="disease" className="FormField__Input" onChange={this.handleChange}></input>
            </div>
            <div>
              <label className="FormField__Label">Date</label>
              <input id="appdate" className="FormField__Input"  onChange={this.handleChange}></input>
            </div>
            <div>
              <label className="FormField__Label">Description</label>
              <input id="description" className="FormField__Input" onChange={this.handleChange}></input>
            </div>
            <div>
